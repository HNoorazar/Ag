...
# %%
# %%time
weight_rowSTD_sav = pd.read_pickle(bio_reOrganized_dir + "county_geodesic_dist_rowSTD.sav")
...
# %%
print ("46113" in list(NDVI_weather["county_fips"].unique()))
print ("46102" in list(NDVI_weather["county_fips"].unique()))

print ("46113" in list(weight_rowSTD_sav.index))
print ("46102" in list(weight_rowSTD_sav.index))
...
# %%
# %%time
filename = (NDVI_weather_data_dir + "monthly_NDVI_county_GeodesicWeight_4_GWR_"
    + str(len(train_years))
