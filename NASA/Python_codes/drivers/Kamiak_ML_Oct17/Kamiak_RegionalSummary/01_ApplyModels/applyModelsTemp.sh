...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/NASA/regionalStat/01_applyModels/error/outer_size_indeks_smooth_county_model.o
#SBATCH  --error=/home/h.noorazar/NASA/regionalStat/01_applyModels/error/outer_size_indeks_smooth_county_model.e
echo
...
# ----------------------------------------------------------------
python /home/h.noorazar/NASA/regionalStat/01_applyModels/00_applyModels.py size indeks smooth county model
