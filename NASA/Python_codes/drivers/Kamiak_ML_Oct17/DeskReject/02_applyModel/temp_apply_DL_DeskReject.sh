...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/NASA/DeskReject/02_apply_DeskReject/error/indeks_smooth_trainID_SR.o
#SBATCH  --error=/home/h.noorazar/NASA/DeskReject/02_apply_DeskReject/error/indeks_smooth_trainID_SR.e
echo
...
python /home/h.noorazar/NASA/DeskReject/02_apply_DeskReject/apply_DL_DeskReject.py indeks smooth trainID SR
