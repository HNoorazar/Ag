...
weather_slope_ANPPBP1 = pd.read_pickle(filename)
print (weather_slope_ANPPBP1['Date'])
print (weather_slope_ANPPBP1['source_code'])

weather_slope_ANPPBP1 = weather_slope_ANPPBP1['sensSlope_beforeAfter_ANPPBP1']
weather_slope_ANPPBP1.head(2)

# %%
y_cols = [x for x in weather_slope_ANPPBP1.columns if ("slope" in x) or ("mean" in x) or ("median" in x)]
...
for a_pattern in y_cols_patterns:
    weather_slope_ANPPBP1[f'{a_pattern}diff'] = weather_slope_ANPPBP1[f"{a_pattern}after"] - \
                                                 weather_slope_ANPPBP1[f"{a_pattern}before"]
    
    weather_slope_ANPPBP1[f"{a_pattern}ratio"] = weather_slope_ANPPBP1[f"{a_pattern}after"] / \
                                                  weather_slope_ANPPBP1[f"{a_pattern}before"]
weather_slope_ANPPBP1.head(2)
...
# %%
# weather_slope_ANPPBP1["temp_slope_diff"] = weather_slope_ANPPBP1["temp_slope_after"] - \
#                                                 weather_slope_ANPPBP1["temp_slope_before"]

# weather_slope_ANPPBP1["temp_slope_ratio"] = weather_slope_ANPPBP1["temp_slope_after"] / \
#                                                 weather_slope_ANPPBP1["temp_slope_before"]
####################################################################################################
# weather_slope_ANPPBP1["precip_slope_diff"] = weather_slope_ANPPBP1["precip_slope_after"] - \
#                                                 weather_slope_ANPPBP1["precip_slope_before"]

# weather_slope_ANPPBP1["precip_slope_ratio"] = weather_slope_ANPPBP1["precip_slope_after"] / \
#                                                 weather_slope_ANPPBP1["precip_slope_before"]
...
Albers_SF_west.drop(columns=["medians_diff_ANPP"], inplace=True)
...
diff_ratio_cols = [x for x in weather_slope_ANPPBP1 if (("diff" in x) or ("ratio" in x))]
cols_ = ["fid"] + diff_ratio_cols

Albers_SF_west = pd.merge(Albers_SF_west, weather_slope_ANPPBP1[cols_], how="left", on="fid")
Albers_SF_west.head(2)
