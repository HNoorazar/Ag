...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/rangeland_bio/rolling_variance/error/weather_variance_rolling_window_size_y_.o
#SBATCH  --error=/home/h.noorazar/rangeland_bio/rolling_variance/error/weather_variance_rolling_window_size_y_.e
echo
...
python /home/h.noorazar/rangeland_bio/rolling_variance/weather_variance_rolling.py window_size y_
