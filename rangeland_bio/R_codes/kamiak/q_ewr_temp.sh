...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/rangeland_bio/ewrs_R/error/ewr_func.o
#SBATCH --error=/home/h.noorazar/rangeland_bio/ewrs_R/error/ewr_func.e
...
Rscript --vanilla /home/h.noorazar/rangeland_bio/ewrs_R/ewrs_kamiak.R ewr_func
