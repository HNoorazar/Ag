...
# Read in the data
rpms_data <- as.data.table(read.table("R2_rpms_stack_cut_filtered_mean_filled_zones_filtered.csv", header = TRUE, sep = ","))
zone_data <- as.data.table(read.table("BpsMskR2Fin_cut.csv", header = TRUE, sep = ","))
