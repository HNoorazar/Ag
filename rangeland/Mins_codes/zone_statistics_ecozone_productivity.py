...
outcsv_file = outcsv_path + "ecozone_annual_productivity.csv"
foutcsv = open(outcsv_file, "w")
foutcsv.write("year,ecozone,productivity\n")
...
for year in range(1984,2022): #,2022):
  ...
  outZonalStatistics = ZonalStatisticsAsTable(ecozone, "Value", test,outtable,"DATA","MEAN")
