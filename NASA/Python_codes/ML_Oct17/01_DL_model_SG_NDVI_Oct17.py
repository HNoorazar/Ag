...
# It is a copy of the old notebook ```01_01_DL_model_NDVI_SG.ipynb```.
...
# %%
VI_idx = "NDVI"
train_folder = '/Users/hn/Documents/01_research_data/NASA/ML_data_Oct17/SG_groundTruth_images_' + VI_idx + '/'
...
def run_test_harness():
    ...
    _model.save(model_dir+"01_TL_" + VI_idx + "_SG_train80_Oct17.h5")
