...
###SBATCH -k o
#SBATCH --output=/home/h.noorazar/rangeland_bio/03_plot_trends_Kamiak/error/03_ACFsigma_moving_window_plot_trend_weather_templ_acf_or_variance.o
#SBATCH  --error=/home/h.noorazar/rangeland_bio/03_plot_trends_Kamiak/error/03_ACFsigma_moving_window_plot_trend_weather_templ_acf_or_variance.e
echo
