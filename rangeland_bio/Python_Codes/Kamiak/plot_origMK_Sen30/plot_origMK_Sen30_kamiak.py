...
orig_plots = bio_plots + "Original_sen30GE_TS/"
...
for a_fid in green_99:
    ...
    if slope_ <= 20:
        ...
        file_name = orig_plots_less20 + "FID_" + str(a_fid) + "_slopeGE30_notGeen.pdf"
    elif (slope_ >= 20) and (slope_ < 30):
        orig_plots_20to30 = orig_plots + "slope_20to30/"
        os.makedirs(orig_plots_20to30, exist_ok=True)

        file_name = orig_plots_20to30 + "FID_" + str(a_fid) + "_slopeGE30_notGeen.pdf"
    elif slope_ >= 30:
        orig_plots_ge30 = orig_plots + "slope_ge30/"
        os.makedirs(orig_plots_ge30, exist_ok=True)
        file_name = orig_plots_ge30 + "FID_" + str(a_fid) + "_slopeGE30_notGeen.pdf"
