...
ACFs_beforeAfter_BP1 = ACFs_beforeAfter_BP1['ACFs_beforeAfter_BP1']
...
# %%
out_dir = ACF_plot_base + "ACF_BABP1/"
...
for a_pattern in patterns:
    ...
    fig.suptitle(f"ACF1-delta and -ratio after and before BP1 ({t_})", y=0.82, fontdict={'family':'serif'});
