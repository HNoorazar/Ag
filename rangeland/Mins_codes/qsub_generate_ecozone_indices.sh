...
#GRID_ID,lat,lon
in_ecozone_gridmet_count_fraction=/weka/data/lab/adam/mingliang.liu/Projects/rangeland/ecozone_gridmet_range_count_fraction.csv
...
out_climate_indicex=/weka/data/lab/adam/mingliang.liu/Projects/rangeland/ecozone_gridmet_mean_indices.csv 
#sys.argv[4] #"/home/liuming/mnt/hydronas3/Projects/Rangeland/county_gridmet_mean_indices.csv"

python /weka/data/lab/adam/mingliang.liu/Projects/rangeland/Kamiak_generate_mean_ecozone_gridmet_climate_indices_from_monthly_gridmet.py ${in_gridid_lat_lon} ${in_ecozone_gridmet_count_fraction} ${in_gridmet_path} ${out_climate_indicex}
